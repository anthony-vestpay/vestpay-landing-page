                ...
                <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a
                            ...
                            className="group flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-1.5 transition-all hover:border-accent/40 hover:shadow-sm"
                        >
                            {/* Stripe S */}
                            <svg className="h-4 w-4 text-muted-foreground transition-colors group-hover:text-accent" viewBox="0 0 24 24" fill="currentColor">
